...
export const LinkedinIcon = () => (
  <svg
    ...
    fill="currentColor"
  >
    <path d="M20.447 20.452h-3.554v-5.569c0-1.327-.027-3.033-1.848-3.033-1.849 0-2.131 1.44-2.131 2.93v5.672H9.36V9h3.413v1.561h.049c.477-.9 1.64-1.85 3.37-1.85 3.6 0 4.262 2.37 4.262 5.45v6.291zM5.337 7a2.06 2.06 0 110-4.12A2.06 2.06 0 015.337 7zm1.78 13.452H3.557V9h3.56v11.452z" />
  </svg>
);
...
export const AppleIcon = () => (
  <svg
    fill="currentColor"
    className="w-3 h-4 sm:w-4 sm:h-5 fill-gray-600 dark:fill-dark-text-secondary"
    viewBox="0 0 22 24"
  >
    <path
